...
class Parser(object):
    ...
    def _parse_argument(cls, token: str) -> Argument:
        ...
        if token.endswith("?*"):
            ...
            return Argument(token.rstrip("*"), is_list=True, description=description,)
        elif token.endswith("?"):
            return Argument(token.rstrip("?"), required=False, description=description,)
        ...
        return Argument(token, description=description,)
